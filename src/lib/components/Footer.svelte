...
<footer class="bg-primary-50 py-16">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            <!-- Brand Section -->
            <div class="space-y-4">
                <h3 class="text-2xl text-primary-700 font-bold">Leticia</h3>
                <p class="text-gray-400">Crafting moments of serenity through the art of scent.</p>
            ...
            <!-- Newsletter -->
            <div>
                <h4 class="text-lg text-primary-700 font-semibold mb-4">Stay Updated</h4>
                <p class="text-gray-400 mb-4 text-[15px]">Subscribe to our newsletter for the latest updates and offers.</p>
                <form class="space-y-2">
                    <input type="email" placeholder="Your email address" class="w-110 bg-white border-2 border-primary-500/20 rounded-lg focus:outline-none focus:border-primary-500 text-dark lg:w-full">
                    <button type="submit" class="btn w-110 bg-[#D4A373] text-[#8D3C42] hover:bg-accent py-2 rounded-lg transition-colors hover:text-primary-700 py-2 rounded-lg transition-colors lg:w-full">
                        Subscribe
                    </button>
                </form>
            </div>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 LuhBela. All rights reserved.</p>
        </div>
    </div>
</footer>
