...
<footer class="bg-primary-50 py-16">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <form class="space-y-2">
                    <input type="email" placeholder="Your email address" class="w-full px-4 py-2 bg-white border-2 border-primary-500/20 rounded-lg focus:outline-none focus:border-primary-500 text-dark">
                    <button type="submit" class="btn w-full bg-[#D4A373] text-[#8D3C42] hover:bg-accent py-2 rounded-lg transition-colors hover:text-primary-700 py-2 rounded-lg transition-colors">
                        Subscribe
                    </button>
                </form>
            </div>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Leticia. All rights reserved.</p>
        </div>
    </div>
</footer>
