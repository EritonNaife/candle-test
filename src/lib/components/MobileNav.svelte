...
<div class="fixed inset-y-0 left-0 z-50 w-full max-w-xs bg-white shadow-xl overflow-y-auto">
  <div class="flex h-full flex-col">
      ...
      <div class="flex justify-between items-center px-4 py-3 bg-[#F9F5F3]/50">
          <a href="/account" class="flex items-center text-[#8D3C42] font-medium">
      ...
      <div class="flex-1 px-4 py-6">
          ...
          <div class="mt-6 space-y-4 border-t border-[#F9F5F3] pt-6">
              ...
              <a href="/about-us" class="flex items-center justify-between py-2 text-base font-medium text-[#8D3C42] hover:bg-[#F9F5F3] px-2 rounded-lg nav-link">
              ...
              <a href="/store-locator" class="flex items-center justify-between py-2 text-base font-medium text-[#8D3C42] hover:bg-[#F9F5F3] px-2 rounded-lg nav-link">
                  Find a Store <Icon icon="material-symbols:chevron-right" class="h-5 w-5 text-[#D4A373]" />
              </a>
          </div>
      </div>
  </div>
